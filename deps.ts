...
// -- @remix-run/xxx --
export { defineRoutes as remixDefineRoutes } from "https://esm.sh/@remix-run/dev@0.0.0-experimental-9784dd06/config/routes?pin=v86&deps=esbuild@0.14.39&target=deno";
export { createRequestHandler as createRemixRequestHandler } from "https://esm.sh/@remix-run/deno@0.0.0-experimental-9784dd06/index.ts?pin=v86&target=deno&deps=react@18.2.0";
